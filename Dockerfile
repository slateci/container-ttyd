...
RUN rm -f /usr/bin/systemd-* /usr/bin/passwd /usr/bin/perl* /usr/bin/whereis /usr/bin/which /usr/bin/wall /usr/bin/vmstat /usr/bin/timedatectl /usr/bin/taskset /bin/system* /bin/*ctl /bin/uname /bin/dmesg
